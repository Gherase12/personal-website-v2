...
function Hero({ openModal }) {
  return (
    <section className='h-auto  pt-14  text-blue-forta relative overflow-hidden'>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1, delay: 0.5 }}
        className='absolute w-[400px] h-[400px] lg:w-[1100px] lg:h-[1100px] lg:-bottom-[250px] lg:-left-[700px]  -left-[280px]  -bottom-[100px] '
      >
      ...
      >
        ...
        <p className='z-50'>project live this week</p>
      </motion.h1>
      ...
      <div className='w-full flex justify-center items-center space-x-3 '>
        ...
        <button
          onClick={openModal}
          className='rounded-full text-black bg-blue-forta mx-auto w-28 h-10 font-bold text-sm shadow-md shadow-blue-forta animate-pulse '
        >
          GET IN TOUCH
        </button>
      ...
      <div className='w-full text-blue-forta mt-32   flex flex-col items-center'>
        <p>Find more</p>
